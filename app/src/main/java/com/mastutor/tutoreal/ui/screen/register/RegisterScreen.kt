...
import com.mastutor.tutoreal.ui.screen.login.LoginContent
...
fun RegisterContent(
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally,
        ...
        OutlinedTextField(
            ...
            placeholder = { Text(text = "full name", style = MaterialTheme.typography.bodySmall.copy(fontWeight = FontWeight.Normal, fontSize = 16.sp) ) },
        ...
        OutlinedTextField(
            ...
            shape = RoundedCornerShape(16.dp),
            colors = TextFieldDefaults.outlinedTextFieldColors(focusedBorderColor = MaterialTheme.colorScheme.primary),
            placeholder = { Text(text = "confirm password", style = MaterialTheme.typography.bodySmall.copy(fontWeight = FontWeight.Normal, fontSize = 16.sp) ) },
            textStyle = MaterialTheme.typography.bodySmall.copy(fontWeight = FontWeight.Normal, fontSize = 16.sp),
            modifier = Modifier
                .scale(scaleX = 0.9F, scaleY = 0.9F)
                .fillMaxWidth()
...
fun RegisterContentPreview(){
    TutorealTheme {
        ...
        var (selectedGender, onGenderSelected) = remember {
